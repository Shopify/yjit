...
ujit_asm.$(OBJEXT): {$(VPATH)}ujit_asm.c
ujit_asm.$(OBJEXT): {$(VPATH)}ujit_asm.h
ujit_codegen.$(OBJEXT): $(CCAN_DIR)/check_type/check_type.h
ujit_codegen.$(OBJEXT): $(CCAN_DIR)/container_of/container_of.h
ujit_codegen.$(OBJEXT): $(CCAN_DIR)/list/list.h
ujit_codegen.$(OBJEXT): $(CCAN_DIR)/str/str.h
ujit_codegen.$(OBJEXT): $(hdrdir)/ruby/ruby.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/array.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/class.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/compile.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/compilers.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/gc.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/imemo.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/serial.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/vm.h
ujit_codegen.$(OBJEXT): $(top_srcdir)/internal/warnings.h
ujit_codegen.$(OBJEXT): {$(VPATH)}assert.h
ujit_codegen.$(OBJEXT): {$(VPATH)}atomic.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/assume.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/bool.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/limits.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
ujit_codegen.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
...
ujit_codegen.$(OBJEXT): {$(VPATH)}id_table.h
ujit_codegen.$(OBJEXT): {$(VPATH)}insns.def
ujit_codegen.$(OBJEXT): {$(VPATH)}insns.inc
ujit_codegen.$(OBJEXT): {$(VPATH)}insns_info.inc
ujit_codegen.$(OBJEXT): {$(VPATH)}intern.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/anyargs.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/assume.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/const.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/error.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/format.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/cast.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/config.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/constant_p.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/robject.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/ctype.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/dllexport.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/dosish.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/error.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/eval.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/event.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/fl_type.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/gc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/glob.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/globals.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/extension.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/feature.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/has/warning.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/array.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/class.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/error.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/file.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/io.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/load.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/object.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/process.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/random.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/range.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/re.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/select.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/string.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/time.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/interpreter.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/iterator.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/memory.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/method.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/module.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/newobj.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/rgengc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/scan_args.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/special_consts.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/static_assert.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/stdalign.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/stdbool.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/symbol.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/token_paste.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/value.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/value_type.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/variable.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/warning_push.h
ujit_codegen.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
ujit_codegen.$(OBJEXT): {$(VPATH)}iseq.h
ujit_codegen.$(OBJEXT): {$(VPATH)}method.h
ujit_codegen.$(OBJEXT): {$(VPATH)}missing.h
ujit_codegen.$(OBJEXT): {$(VPATH)}node.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ruby_assert.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ruby_atomic.h
ujit_codegen.$(OBJEXT): {$(VPATH)}st.h
ujit_codegen.$(OBJEXT): {$(VPATH)}subst.h
ujit_codegen.$(OBJEXT): {$(VPATH)}thread_$(THREAD_MODEL).h
ujit_codegen.$(OBJEXT): {$(VPATH)}thread_native.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_asm.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_codegen.c
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_codegen.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_core.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_iface.h
ujit_codegen.$(OBJEXT): {$(VPATH)}ujit_utils.h
ujit_codegen.$(OBJEXT): {$(VPATH)}vm_callinfo.h
ujit_codegen.$(OBJEXT): {$(VPATH)}vm_core.h
ujit_codegen.$(OBJEXT): {$(VPATH)}vm_debug.h
ujit_codegen.$(OBJEXT): {$(VPATH)}vm_opts.h
ujit_codegen.$(OBJEXT): {$(VPATH)}vm_sync.h
ujit_compile.$(OBJEXT): $(CCAN_DIR)/check_type/check_type.h
ujit_compile.$(OBJEXT): $(CCAN_DIR)/container_of/container_of.h
ujit_compile.$(OBJEXT): $(CCAN_DIR)/list/list.h
...
ujit_compile.$(OBJEXT): $(top_srcdir)/internal/serial.h
ujit_compile.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
ujit_compile.$(OBJEXT): $(top_srcdir)/internal/vm.h
ujit_compile.$(OBJEXT): $(top_srcdir)/internal/warnings.h
ujit_compile.$(OBJEXT): {$(VPATH)}assert.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/assume.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/bool.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/limits.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
ujit_compile.$(OBJEXT): {$(VPATH)}backward/2/stdarg.h
ujit_compile.$(OBJEXT): {$(VPATH)}builtin.h
ujit_compile.$(OBJEXT): {$(VPATH)}config.h
ujit_compile.$(OBJEXT): {$(VPATH)}debug_counter.h
ujit_compile.$(OBJEXT): {$(VPATH)}defines.h
ujit_compile.$(OBJEXT): {$(VPATH)}id.h
ujit_compile.$(OBJEXT): {$(VPATH)}insns.def
ujit_compile.$(OBJEXT): {$(VPATH)}insns.inc
ujit_compile.$(OBJEXT): {$(VPATH)}insns_info.inc
ujit_compile.$(OBJEXT): {$(VPATH)}intern.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/anyargs.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/assume.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/const.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/error.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/format.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/cast.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/config.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/constant_p.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/robject.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/ctype.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/dllexport.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/dosish.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/error.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/eval.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/event.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/fl_type.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/gc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/glob.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/globals.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/extension.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/feature.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/has/warning.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/array.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/class.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/error.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/file.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/io.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/load.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/object.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/process.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/random.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/range.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/re.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/select.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/string.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/time.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/interpreter.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/iterator.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/memory.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/method.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/module.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/newobj.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/rgengc.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/scan_args.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/special_consts.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/static_assert.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/stdalign.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/stdbool.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/symbol.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/token_paste.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/value.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/value_type.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/variable.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/warning_push.h
ujit_compile.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
ujit_compile.$(OBJEXT): {$(VPATH)}iseq.h
ujit_compile.$(OBJEXT): {$(VPATH)}method.h
ujit_compile.$(OBJEXT): {$(VPATH)}missing.h
ujit_compile.$(OBJEXT): {$(VPATH)}node.h
ujit_compile.$(OBJEXT): {$(VPATH)}ruby_assert.h
ujit_compile.$(OBJEXT): {$(VPATH)}ruby_atomic.h
ujit_compile.$(OBJEXT): {$(VPATH)}st.h
ujit_compile.$(OBJEXT): {$(VPATH)}subst.h
ujit_compile.$(OBJEXT): {$(VPATH)}thread_$(THREAD_MODEL).h
...
ujit_core.$(OBJEXT): $(CCAN_DIR)/check_type/check_type.h
ujit_core.$(OBJEXT): $(CCAN_DIR)/container_of/container_of.h
ujit_core.$(OBJEXT): $(CCAN_DIR)/list/list.h
ujit_core.$(OBJEXT): $(CCAN_DIR)/str/str.h
ujit_core.$(OBJEXT): $(hdrdir)/ruby/ruby.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/array.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/compilers.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/gc.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/imemo.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/serial.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/vm.h
ujit_core.$(OBJEXT): $(top_srcdir)/internal/warnings.h
ujit_core.$(OBJEXT): {$(VPATH)}assert.h
ujit_core.$(OBJEXT): {$(VPATH)}atomic.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/assume.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/bool.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/limits.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
ujit_core.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
...
ujit_core.$(OBJEXT): {$(VPATH)}insns.def
ujit_core.$(OBJEXT): {$(VPATH)}insns.inc
ujit_core.$(OBJEXT): {$(VPATH)}insns_info.inc
ujit_core.$(OBJEXT): {$(VPATH)}intern.h
ujit_core.$(OBJEXT): {$(VPATH)}internal.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/anyargs.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/assume.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/const.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/error.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/format.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/cast.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/config.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/constant_p.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/robject.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/ctype.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/dllexport.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/dosish.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/error.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/eval.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/event.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/fl_type.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/gc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/glob.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/globals.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/extension.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/feature.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/has/warning.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/array.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/class.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/error.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/file.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/io.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/load.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/object.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/process.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/random.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/range.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/re.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/select.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/string.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/time.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/interpreter.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/iterator.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/memory.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/method.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/module.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/newobj.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/rgengc.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/scan_args.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/special_consts.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/static_assert.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/stdalign.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/stdbool.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/symbol.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/token_paste.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/value.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/value_type.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/variable.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/warning_push.h
ujit_core.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
ujit_core.$(OBJEXT): {$(VPATH)}iseq.h
ujit_core.$(OBJEXT): {$(VPATH)}method.h
ujit_core.$(OBJEXT): {$(VPATH)}missing.h
ujit_core.$(OBJEXT): {$(VPATH)}node.h
ujit_core.$(OBJEXT): {$(VPATH)}ruby_assert.h
ujit_core.$(OBJEXT): {$(VPATH)}ruby_atomic.h
ujit_core.$(OBJEXT): {$(VPATH)}st.h
ujit_core.$(OBJEXT): {$(VPATH)}subst.h
ujit_core.$(OBJEXT): {$(VPATH)}thread_$(THREAD_MODEL).h
ujit_core.$(OBJEXT): {$(VPATH)}thread_native.h
ujit_core.$(OBJEXT): {$(VPATH)}ujit_asm.h
ujit_core.$(OBJEXT): {$(VPATH)}ujit_codegen.h
ujit_core.$(OBJEXT): {$(VPATH)}ujit_core.c
ujit_core.$(OBJEXT): {$(VPATH)}ujit_core.h
ujit_core.$(OBJEXT): {$(VPATH)}ujit_iface.h
ujit_core.$(OBJEXT): {$(VPATH)}ujit_utils.h
ujit_core.$(OBJEXT): {$(VPATH)}vm_callinfo.h
ujit_core.$(OBJEXT): {$(VPATH)}vm_core.h
...
ujit_iface.$(OBJEXT): $(CCAN_DIR)/str/str.h
ujit_iface.$(OBJEXT): $(hdrdir)/ruby/ruby.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/array.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/class.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/compile.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/compilers.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/gc.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/imemo.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/serial.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/vm.h
ujit_iface.$(OBJEXT): $(top_srcdir)/internal/warnings.h
ujit_iface.$(OBJEXT): {$(VPATH)}assert.h
ujit_iface.$(OBJEXT): {$(VPATH)}atomic.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/assume.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/bool.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/limits.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
ujit_iface.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
...
ujit_iface.$(OBJEXT): {$(VPATH)}id_table.h
ujit_iface.$(OBJEXT): {$(VPATH)}insns.def
ujit_iface.$(OBJEXT): {$(VPATH)}insns.inc
ujit_iface.$(OBJEXT): {$(VPATH)}insns_info.inc
ujit_iface.$(OBJEXT): {$(VPATH)}intern.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/anyargs.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/assume.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/const.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/error.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/format.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/cast.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/config.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/constant_p.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/robject.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/ctype.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/dllexport.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/dosish.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/error.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/eval.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/event.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/fl_type.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/gc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/glob.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/globals.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/extension.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/feature.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/has/warning.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/array.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/class.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/error.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/file.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/io.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/load.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/object.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/process.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/random.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/range.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/re.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/select.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/string.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/time.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/interpreter.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/iterator.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/memory.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/method.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/module.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/newobj.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/rgengc.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/scan_args.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/special_consts.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/static_assert.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/stdalign.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/stdbool.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/symbol.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/token_paste.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/value.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/value_type.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/variable.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/warning_push.h
ujit_iface.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
ujit_iface.$(OBJEXT): {$(VPATH)}iseq.h
ujit_iface.$(OBJEXT): {$(VPATH)}method.h
ujit_iface.$(OBJEXT): {$(VPATH)}missing.h
ujit_iface.$(OBJEXT): {$(VPATH)}node.h
ujit_iface.$(OBJEXT): {$(VPATH)}ruby_assert.h
ujit_iface.$(OBJEXT): {$(VPATH)}ruby_atomic.h
ujit_iface.$(OBJEXT): {$(VPATH)}st.h
ujit_iface.$(OBJEXT): {$(VPATH)}subst.h
...
ujit_iface.$(OBJEXT): {$(VPATH)}ujit_hooks.inc
ujit_iface.$(OBJEXT): {$(VPATH)}ujit_iface.c
ujit_iface.$(OBJEXT): {$(VPATH)}ujit_iface.h
ujit_iface.$(OBJEXT): {$(VPATH)}vm_callinfo.h
ujit_iface.$(OBJEXT): {$(VPATH)}vm_core.h
ujit_iface.$(OBJEXT): {$(VPATH)}vm_debug.h
ujit_iface.$(OBJEXT): {$(VPATH)}vm_opts.h
ujit_iface.$(OBJEXT): {$(VPATH)}vm_sync.h
...
version.$(OBJEXT): {$(VPATH)}ujit_asm.h
version.$(OBJEXT): {$(VPATH)}ujit_core.h
version.$(OBJEXT): {$(VPATH)}ujit_iface.h
